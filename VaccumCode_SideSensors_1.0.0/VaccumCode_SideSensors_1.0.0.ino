//Code: VaccumCode_SideSensorsBeta
...
void loop(){
  ...
  if (control){
    ...
    else if (sdSHARP(SD3)<=10){
      ////////////Make decisions here/////////////
      //If it detects a wall on the left side sensor
      //Follow the wall 
      leftMotors(100);
      if (sdSHARP(SD3)<=4.3){
        //If the wall is too close avoid it 
        rightMotors(100);
        }
      }
    else if (sdSHARP(SD4)<=10){
      ////////////Make decisions here/////////////
      //If it detects a wall on the right side sensor
      //Follow the wall 
      rightMotors(100);
      if (sdSHARP(SD4)<=4.3){
        //If the wall is too close avoid it 
